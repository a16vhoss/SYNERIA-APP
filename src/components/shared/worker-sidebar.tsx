      ...
      <Link href={item.href} className="block">
        ...
        >
          ...
          <AnimatePresence>
            {isActive && (
              <motion.div
                layoutId="worker-active-indicator"
    ...
    <div className="flex h-full flex-col bg-cream">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <button
            onClick={() => {
              // TODO: wire up sign-out via supabase
      ...
      <div className="border-t border-brand-100 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-muted-foreground">Worker</p>
          </div>
        </div>
      </div>
    </div>
...
export { DesktopSidebar as WorkerDesktopSidebar, MobileSidebar as WorkerMobileSidebar };
